...
def training_iter(args):
    ...
    for t in range(epoch):
        ...
        if t != 0 and t % 200 == 0:
            torch.save(model, os.path.join(output_path, "checkpoints/gru_epoch_{}.pth".format(t)))
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--model", help="GRU", default="GRU")
    ...
    parser.add_argument("-hs", "--hidden_size", help="Hidden_size of GRU units.", default=128)
